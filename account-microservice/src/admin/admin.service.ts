...
import { EditTokenParameter } from 'src/account/account.parameter';
import { CreateAdminUserDto } from '../account/admin/dto/create-admin-user.dto';
import { AdminUserResponseDto } from '../account/admin/dto/admin-user-response.dto';
...
export class AdminService {
  ...
  createAdminUser(
    ...
    return this.accountKafkaClientService.send<AdminUserResponseDto>(
  ...
  async login(loginDto: LogInDto) {
    ...
    const userDto =
      await this.accountKafkaClientService.send<AdminUserResponseDto>(
